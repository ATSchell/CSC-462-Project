...
def run():
    ...
    # export ndvi image
    ndvi_image = rasterio.open('./Output/result-' + str(os.getpid()) + '.tiff', 'w', driver='Gtiff', width=band11.width,
                              height=band11.height,count=1, crs=band11.crs, transform=band11.transform, dtype='float32')
